df <- read.csv("C:/Users/Arundhati singh/Downloads/WHO-COVID-19-global-data (2).csv")
df
View(df)
...
countries <- df %>%
  filter(Country == "Oman" | Country == "India")
############################## Cumulative cases######################################################
# histogram of cumulative cases of Oman and India

ggplot(countries, aes(x = Cumulative_cases, fill = Country))+
  geom_histogram(bins = 20)+
  ggtitle("cumulative cases of saudi arabia and zambia")

# LINE PLOT of cumulative cases of Oman and India

ggplot(countries, aes(x=ï..Date_reported, y=Cumulative_cases, color = Country, group=1)) +
  geom_line()+
  ggtitle("cumulative cases of Oman and India")+
  xlab(" Dates")+
  ylab("New Cases")+
  theme_ipsum()

#Boxplot of cumulative cases of Oman and India
...
########################################## New cases ##############################################
# histogram of new cases of Oman and India

ggplot(countries, aes(x = New_cases, fill = Country))+
  geom_histogram(bins = 20)+
  ggtitle("New cases of Oman and India")
...
#Boxplot of new cases of Oman and India
...
# histogram of cumulative deaths of Oman and  India

ggplot(countries, aes(x = Cumulative_deaths, fill = Country))+
  geom_histogram(bins = 20)+
  ggtitle("cumulative Deaths of Oman and India")

# LINE PLOT of cumulative deaths of Oman and India
...
# histogram of New Deaths of Oman and  India in 2020

ggplot(countries2020, aes(x = New_deaths, fill = Country))+
  geom_histogram(bins = 20)+
  ggtitle("New cases of Oman and India in 2020")

# LINE PLOT of cumulative deaths of Oman and India in 2020

ggplot(countries2020, aes(x=ï..Date_reported, y=Cumulative_deaths, color = Country, group=1)) +
  geom_line()+
  ggtitle("cumulative Deaths of Oman and India in 2020")+
  xlab(" Dates")+
  ylab("New Cases")+
  theme_ipsum()

#Boxplot of cumulative cases of Oman and India in 2020
ggplot(countries2020,aes(x=Country, y=Cumulative_cases, fill=Cumulative_cases, color = Country)) +
  ...
  ggtitle("Boxplot of cumulative cases of Oman and India in 2020 ") +
  xlab("")

#Barplot of new cases of Oman and India in 2020 
...
# histogram of New Deaths of Oman and India in 2021

ggplot(countries2021, aes(x = New_deaths, fill = Country))+
  geom_histogram(bins = 20)+
  ggtitle("New cases of Oman and India in 2021")

# LINE PLOT of cumulative deaths of Oman and India in 2021

ggplot(countries2021, aes(x=ï..Date_reported, y=Cumulative_deaths, color = Country, group=1)) +
  geom_line()+
  ggtitle("cumulative Deaths of Oman and India in 2021")+
  xlab(" Dates")+
  ylab("New Cases")+
  theme_ipsum()

#Boxplot of cumulative cases of Oman and India in 2021
ggplot(countries2021,aes(x=Country, y=Cumulative_cases, fill=Cumulative_cases, color = Country)) +
  ...
  ggtitle("Boxplot of cumulative cases of Oman and India in 2021 ") +
  xlab("")

#Barplot of new cases of Oman and India in 2021 
...
# histogram of New Deaths of Oman and  India in 2022

ggplot(countries2022, aes(x = New_deaths, fill = Country))+
  geom_histogram(bins = 20)+
  ggtitle("New cases of Oman and India in 2022")

# LINE PLOT of cumulative deaths of Oman and India in 2022

ggplot(countries2022, aes(x=ï..Date_reported, y=Cumulative_deaths, color = Country, group=1)) +
  geom_line()+
  ggtitle("cumulative Deaths of Oman and India in 2022")+
  xlab(" Dates")+
  ylab("New Cases")+
  theme_ipsum()

#Boxplot of cumulative cases of oman and India in 2022
ggplot(countries2022,aes(x=Country, y=Cumulative_cases, fill=Cumulative_cases, color = Country)) +
  ...
  ggtitle("Boxplot of cumulative cases of Oman and India in 2022 ") +
  xlab("")

#Barplot of new cases of Oman and India in 2022 
...
OmanChinaIndia<-df%>% filter(Country=='Oman'|Country=='China'| Country == 'India')
View(OmanChinaIndia)


ggplot(OmanChinaIndia, aes(x = ï..Date_reported, y = New_deaths, color = Country, group = Country))+
  geom_line(size = 1.0)+
...
ggplot(OmanChinaIndia, aes(x=ï..Date_reported, y = Cumulative_deaths, group=Country, color = Country)) +
  geom_line(size = 1.0) +
  scale_x_discrete(breaks=c(2020,2021,2022))+
  theme_ipsum()+
...
ggplot(OmanChinaIndia, aes(x=ï..Date_reported, y = New_cases, group=Country, color = Country)) +
  geom_line(size = 1.0) +
  scale_x_discrete(breaks=c(2020,2021,2022))+
  theme_ipsum()+
...
ggplot(OmanChinaIndia, aes(x=ï..Date_reported, y = Cumulative_cases, group=Country, color = Country))+
  geom_line(size = 1.0)+
  scale_x_discrete(breaks=c(2020,2021,2022))+
  theme_ipsum()+
  ggtitle("Comparing New Covid Cases for India USA and China over the Years")+
